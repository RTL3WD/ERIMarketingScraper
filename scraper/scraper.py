...
#from send_to_gpt import send_to_gpt
...
def scraper():
    ...
    while court_index <= 61:
        ...
        try:
            ...
            court_index, existing_df = select_court(driver, anticaptcha_key, court_index,existing_df)
        except:
        ...
        export_df.to_csv('scrape-results.csv',index=False)
